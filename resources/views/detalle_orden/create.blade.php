...
<div class="py-8">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Encabezado -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-900">Agregar Detalle de Orden</h1>
            <p class="text-gray-600 mt-1">Registra los materiales usados en la orden de producción</p>
        </div>

        <form action="{{ route('detalle_orden.store') }}" method="POST" class="bg-white shadow-md rounded-lg p-6 space-y-4">
            @csrf
            ...
            <div>
                ...
                <input type="number" step="0.01" name="cantidad_usada" required
                    class="mt-1 block w-full rounded-xl border border-gray-300 shadow-sm focus:ring-2 focus:ring-green-200 focus:border-green-500 sm:text-sm px-3 py-2">
            </div>
